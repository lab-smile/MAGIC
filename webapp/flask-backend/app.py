    ...
    try:
        ...
        subprocess.run(
            ['/home/ubuntu/.conda/envs/magic_env/bin/python', '/home/ubuntu/MAGIC/src/gpu/pytorch_pix2pix_test.py',
             '--dataset', upload_dir, '--model_path', '/home/ubuntu/MAGIC/src/MAGIC_Generator_FINAL.pkl'], check=True)

        # Run the second shell command with a specified current working directory
        subprocess.run(['./run_generate_series.sh', '/usr/local/MATLAB/MATLAB_Runtime/R2023a/', f"{upload_dir}/test",
