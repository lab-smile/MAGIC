...
# For running in terminal within Jupyter Notebooks
python pytorch_pix2pix.py --dataset ../data/dataset_A2 --lrG 0.0001 --lrD 0.0001 --train_epoch 50 --save_root results --num_workers 8 --batch_size 8 --val_subfolder test
python pytorch_pix2pix.py --dataset ../data/dataset_sample --lrG 0.0001 --lrD 0.0001 --train_epoch 1 --save_root results --num_workers 1 --batch_size 1 --val_subfolder test --use_augmentations False