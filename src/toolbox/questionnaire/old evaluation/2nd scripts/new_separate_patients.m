%% Driver for separating patients and creating column views
%
...
for j = 1: length(patients)
    ...
    for i = 1 : length(all_images)
       ...
       blank = zeros(256,256,3);
          ...
          CT_Column = insertText(CT_Column, [0,100], 'NCCT   CBV   CBF   MTT   TMAX', 'FontSize', 80, 'BoxColor', 'black', 'TextColor', 'white');
